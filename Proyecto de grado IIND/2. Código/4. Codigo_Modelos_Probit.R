...
stargazer(probit_model, type = "text", out = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/5. Salidas de R/15. probit_model_pm25.doc")
...
p_pm25_col2 <- ggplot(data_ws_col2, aes(ws_class, mean_prob, col = month)) +
  ...
  labs(x = "Velocidad del Viento", 
       y = "Probabilidad",
       title = "Evoluación de la probabilidad con Viento - PM25") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold"),  # Centra y ajusta el título
    axis.title = element_text(size = 14),  # Ajusta el tamaño de las etiquetas de los ejes
...
# Variable dependiente: ex_pm
# as.factor(X): Definir variable como una categorica
probit_model <- glm(formula = ex_no2 ~ rain + tmp + ws + as.factor(dow) + as.factor(month) + as.factor(year),
                    data = data, 
                    family = binomial(link = "probit")) 

# Chequeo de los resultados
stargazer(probit_model, type = "text", out = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/5. Salidas de R/17. probit_model_no2.doc")
...
p_no2_prob <- ggplot(data, aes(myday, ex_no2_hat)) +
  ...
  labs(x = "Tiempo", 
       y = "Probabilidad",
       title = "Evoluación de la probabilidad - NO2") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold"),  # Centra y ajusta el título
    axis.title = element_text(size = 14),  # Ajusta el tamaño de las etiquetas de los ejes
...
# -----------------------------------------------------------
# Sección 2: Modelo Probit PM10
# -----------------------------------------------------------

## Variable de excesos y modelación binaria
# Crear variables de los excedentes
data <- data %>% mutate(ex_pm = case_when(pm10 >= 45 ~ 1,
                                          .default = 0))
...
# Chequeo de los resultados
stargazer(probit_model, type = "text", out = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/5. Salidas de R/16. probit_model_pm10.doc")
...
p_pm10_prob <- ggplot(data, aes(myday, ex_pm_hat)) +
  geom_line() +
  labs(x = "Tiempo", 
       y = "Probabilidad",
       title = "Evoluación de la probabilidad - PM10") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold"),  # Centra y ajusta el título
    axis.title = element_text(size = 14),  # Ajusta el tamaño de las etiquetas de los ejes
...
# Exportar como PNG
ggsave("26. Evoluación de la probabilidad PM10.png", 
       plot = last_plot(),
       path = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/4. Gráficos", 
       width = 10, height = 6, units = "in", dpi = 300)
...
p_pm25_prob2 <- ggplot(data, aes(ws, ex_pm_hat)) +
  ...
  labs(x = "Velocidad del Viento", 
       y = "Probabilidad",
       title = "Evoluación de la probabilidad con Viento - PM10") +
  theme_minimal() +
  theme(
    plot.title = element_text(hjust = 0.5, size = 16, face = "bold"),  # Centra y ajusta el título
    axis.title = element_text(size = 14),  # Ajusta el tamaño de las etiquetas de los ejes
...
# Exportar como PNG
ggsave("27. Evoluación de la probabilidad con Viento - PM10.png", 
       plot = last_plot(),
       path = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/4. Gráficos", 
       width = 10, height = 6, units = "in", dpi = 300)
...
# Exportar como PNG
ggsave("28. Evoluación de la probabilidad con Viento - PM10.png", 
       plot = last_plot(),
       path = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/4. Gráficos", 
       width = 10, height = 6, units = "in", dpi = 300)
...
# Exportar como PNG
ggsave("29. Evoluación de la probabilidad con Viento - PM10.png", 
       plot = last_plot(),
       path = "C:/Users/windows/Documents/GitHub/Problem_Set_1/Proyecto-de-grado-IIND/Proyecto de grado IIND/4. Gráficos", 
       width = 10, height = 6, units = "in", dpi = 300)
